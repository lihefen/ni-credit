...
<template>
    <div class="main">
        ...
        <div class="pop" v-if="showPop">
            ...
            <div class="item">
                <a href="javascript:;" class="btn1"><span></span><div>Reduce Limit</div></a>
                <a href="javascript:;" class="btn2"><span></span><div>Escalate to Supervisor</div></a>
                <a href="javascript:;" class="btn3"><span></span><div>Override Approve (Supervisor)</div></a>
            </div>
        </div>
